...
#define STRING_CONFIG_H_AUTHOR "(Jeff Balderson, BG8 Prusa i3)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 144 }
...
#define BLTOUCH
  ...
  #define BLTOUCH_DELAY 10   // (ms) Enable and increase if needed
#endif
